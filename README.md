...
- 项目地址: https://github.com/ichenxin/shadowsocksr
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/ichenxin/doubibackup/master/ssrmu.sh && chmod +x ssrmu.sh && bash ssrmu.sh
```
